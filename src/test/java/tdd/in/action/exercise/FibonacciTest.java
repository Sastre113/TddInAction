...
class FibonacciTest {
    ...
    public void givenAnyNumber_whenGenerar_thenNotEmptyList(int number){
        // Act
    ...
    @ValueSource(ints = {1, 2, 3, 5})
    @DisplayName("Test que comprueba el tipo de retorno")
    public void givenAnyNumber_whenGenerar_thenListSizeEqualsNumber(int number){
        // Act
        List<Integer> sucessionList = fibonacci.generar(number);
    ...
    public void givenFirstTenNumbers_whenGenerar_thenExpectedListIsSameAsGenerated(){
        // Arrange
